...
:::note
In the future, all dependencies beyond the binary itself will be managed
through Nix. For now, you need to set them up manually. See
[External Dependencies](/reference/dependencies/) for what each service does
and why it's needed.
:::
