...
1. **Install GHOST**
   ...
   ```bash
   nix profile add github:mrtolkien/GHOST/latest --refresh
   ```
...
| --------------------------------------------------------- | ----------------------------- |
| `nix profile add github:mrtolkien/GHOST/latest --refresh` | Latest release (recommended)  |
| `nix profile add github:mrtolkien/GHOST/main --refresh`   | Bleeding edge (latest commit) |
| `nix profile add github:mrtolkien/GHOST/v0.5.0 --refresh` | Pinned version                |
