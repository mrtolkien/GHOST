...
1. **note-writer** — Guides the GHOST through creating well-structured notes with proper
   archetypes, tags, and wiki links
2. **reference-researcher** — Strategies for importing and organizing reference material
3. **cron-job-author** — How to write job definitions with proper frontmatter
4. **skill-creator** — Meta-skill for creating new skills
