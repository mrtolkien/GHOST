...
use super::definition::{AgentDefinition, load_agent};
...
impl AgentRunner {
    ...
    pub async fn start(
        ...
        let handle = AgentHandle {
            ...
            task_handle: self.spawn_agent_task(
                definition,
                prompt.to_string(),
                agent_session_id,
                job_log_id,
    ...
    pub async fn take_completed(&self, agent_id: &str) -> Option<(AgentStatus, Option<Thing>)> {
