...
3. If concerns: Raise them with the OPERATOR before starting
4. If no concerns: Create `todo(action: "plan", ...)` and proceed
...
- Never start implementation on main/master branch without explicit OPERATOR consent
