...
**Writing skill before testing (skipping RED)** Reveals what YOU think needs preventing,
not what ACTUALLY needs preventing. Fix: Always run baseline scenarios first.
...
**Stopping after first pass** Tests pass once != bulletproof. Fix: Continue REFACTOR
cycle until no new rationalizations.
