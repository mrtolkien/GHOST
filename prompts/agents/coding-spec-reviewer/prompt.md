...
`compliant` to true only if the implementation matches the spec after code inspection.
Set `issues` to a detailed description of what's missing or extra, with file:line
references.
