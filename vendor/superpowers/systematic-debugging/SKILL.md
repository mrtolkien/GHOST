...
1. **Create Failing Test Case**
   ...
   - Use the `superpowers:test-driven-development` skill for writing proper failing
     tests
...
- **superpowers:test-driven-development** - For creating failing test case (Phase 4,
  Step 1)
- **superpowers:verification-before-completion** - Verify fix worked before claiming
  success
