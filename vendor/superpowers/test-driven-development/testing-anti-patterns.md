...
**The Iron Rule:** Mock the COMPLETE data structure as it exists in reality, not just
...
**If you're testing mock behavior, you violated TDD** - you added mocks without watching
test fail against real code first.
